...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "24NyPOzn49LtIEkJC3EHDixPX", consumerSecret: "A1jWcvCGxRETT8PEyQLTlubyrb8qcEebajciV9HAfOsfycTRl1")
    var loginSuccess: (() -> ())?
